...
class EvmDexTokenProfileMessage(UniversalBaseModel):
    ...
    metadata: typing.Optional[EvmDexTokenProfileMetadata] = None
    metrics: typing.Optional[typing.Dict[str, EvmDexTokenProfileMetrics]] = None
