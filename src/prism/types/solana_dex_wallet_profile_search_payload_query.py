...
class SolanaDexWalletProfileSearchPayloadQuery(UniversalBaseModel):
    fields: typing.Optional[typing.List[SolanaDexWalletProfileSearchPayloadQueryTargetsEnum]] = pydantic.Field(
        default=None
    )
    """
