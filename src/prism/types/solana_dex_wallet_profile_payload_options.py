...
class SolanaDexWalletProfilePayloadOptions(UniversalBaseModel):
    """
    ...
    include_identity: typing.Optional[bool] = pydantic.Field(default=None)
    """
    ...
    include_metrics: typing.Optional[typing.List[SolanaDexWalletProfileTimeWindowEnum]] = pydantic.Field(default=None)
    """
