...
class EvmDexTokenProfileSearchPayloadQueryField(UniversalBaseModel):
    fields: typing.Optional[typing.List[EvmDexTokenProfileSearchPayloadQueryFieldTargetsEnum]] = pydantic.Field(
        default=None
    )
    """
