...
class EvmDexTokenProfilePayloadOptions(UniversalBaseModel):
    """
    ...
    include_metrics: typing.Optional[typing.List[EvmDexTokenProfileTimeWindowEnum]] = pydantic.Field(default=None)
    """
