...
class SolanaDexPositionProfilePayloadOptions(UniversalBaseModel):
    """
    ...
    include_metrics: typing.Optional[typing.List[SolanaDexPositionProfileTimeWindowEnum]] = pydantic.Field(default=None)
    """
