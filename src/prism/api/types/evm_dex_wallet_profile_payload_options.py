...
class EvmDexWalletProfilePayloadOptions(UniversalBaseModel):
    """
    ...
    include_metrics: typing.Optional[typing.List[EvmDexWalletProfileTimeWindowEnum]] = pydantic.Field(default=None)
    """
