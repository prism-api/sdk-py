...
from prism.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from prism.core.request_options import RequestOptions
...
@patch("prism.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("prism.core.http_client.asyncio.sleep", new_callable=AsyncMock)
